...
from deep_eurorack_control.datasets.nsynth_dataset_fader import NSynthDataset_Fader
...
def nsynth_data_loader_fader(batch_size, data_dir=settings.DATA_DIR, audio_dir=settings.AUDIO_DIR, valid_ratio=0.2, num_threads=0):
    # Load the dataset for the training/validation sets
    train_valid_set = NSynthDataset_Fader(
        data_dir=data_dir,
        audio_dir=audio_dir,
